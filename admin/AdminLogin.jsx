  ...
  return (
    <PageTransition>
      <div className="min-h-screen bg-[#060814] text-slate-100 flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <div className="absolute bottom-[-20%] right-[-20%] w-[500px] h-[500px] bg-orange-600/5 rounded-full blur-[120px] pointer-events-none"></div>
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="flex flex-col items-center mb-8">
            <Link to="/" className="flex items-center space-x-2 mb-2">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-vibrant-orange to-red-600 flex items-center justify-center text-white shadow-lg shadow-orange-500/20">
                <ShieldCheck className="w-5 h-5 font-bold" />
              </div>
              <span className="text-2xl font-bold tracking-tight text-white font-sans">
                Iconic<span className="text-vibrant-orange">Admin</span>
              </span>
            </Link>
          ...
          <div className="glass-panel p-8 rounded-3xl border border-white/10 shadow-2xl bg-slate-900/40 backdrop-blur-xl space-y-6">
            <div className="text-center space-y-1">
              ...
              <p className="text-xs text-slate-400">Authenticate to access platform analytics and controls</p>
            </div>
            ...
            <form onSubmit={handleAdminLogin} className="space-y-4">
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-950/80 border border-slate-800 focus:border-vibrant-orange focus:ring-1 focus:ring-vibrant-orange rounded-xl py-3 pl-11 pr-4 text-sm text-white placeholder-slate-600 outline-none transition-all"
                  />
                </div>
              </div>

              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-slate-300 uppercase tracking-wider">Passkey</label>
                <div className="relative">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3.5 bg-gradient-to-r from-vibrant-orange to-red-500 hover:brightness-110 text-white font-semibold rounded-xl shadow-lg active:scale-[0.99] transition-all flex items-center justify-center space-x-2 disabled:opacity-50"
              >
                {loading ? (
            ...
            <div className="relative flex py-2 items-center">
              ...
              <span className="flex-shrink mx-4 text-[9px] text-slate-500 uppercase tracking-widest font-bold">Quick Demo Entry</span>
              <div className="flex-grow border-t border-slate-800/80"></div>
            </div>

            <button
              onClick={prefillCredentials}
              className="w-full py-3 bg-slate-950 border border-slate-800 hover:bg-slate-900 rounded-xl text-xs font-bold text-slate-300 hover:text-white transition-all flex items-center justify-center gap-1.5"
            >
              <Terminal className="w-3.5 h-3.5 text-vibrant-orange" />
