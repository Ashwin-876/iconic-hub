  ...
  const mentors = [
    {
      ...
      credentials: "Senior Architect @ NVIDIA, Cloud Native Board",
    ...
    },
    {
      name: "David Sterling",
      role: "SRE Consultant",
      credentials: "Author of High-Scale Infrastructure",
        ...
        <main className="relative min-h-screen text-left">
          ...
          <section className="relative w-full h-[60vh] flex items-center justify-center overflow-hidden">
            <div className="absolute inset-0 z-0">
              <img 
                alt="DevOps command center" 
                className="w-full h-full object-cover brightness-[0.6] contrast-[1.1]" 
                src="https://images.unsplash.com/photo-1618401471353-b98aedd07871?auto=format&fit=crop&q=80&w=1200" 
              />
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
              ...
              <p className="text-base md:text-lg text-white/90 max-w-2xl mx-auto mb-10 leading-relaxed drop-shadow-[0_2px_6px_rgba(0,0,0,0.5)]">
                Engineer resilient, highly-scalable cloud infrastructure. Master automated containerization, Kubernetes orchestration, continuous integration, and observability stacks.
              </p>
              ...
              <div className="lg:col-span-8 flex flex-col gap-8">
                ...
                <div className="glass-card p-8 rounded-2xl flex flex-col md:flex-row items-center gap-10">
                  ...
                  <div className="flex-grow text-left">
                    <h3 className="text-2xl font-bold text-[#261812] mb-2">Current Focus: Orchestration &amp; Kubernetes Clusters</h3>
                    <p className="text-sm text-[#5a4136] mb-6">
                      You are mastering automated pods scaling. Complete the configuration lab to unlock Phase 3: "CI/CD Pipeline Automation".
                    </p>
                    <div className="flex items-center gap-6">
                      <div className="flex -space-x-3">
                        <div className="w-12 h-12 rounded-full border-4 border-white bg-vibrant-orange/10 flex items-center justify-center cursor-pointer" title="Container Specialist">
                          <Cpu className="w-5 h-5 text-vibrant-orange" />
                        </div>
                        <div className="w-12 h-12 rounded-full border-4 border-white bg-vibrant-orange/10 flex items-center justify-center cursor-pointer" title="SRE Intern">
                      ...
                      <div>
                        ...
                        <span className="text-base font-bold text-[#261812]">2 of 10 Badges Earned</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="glass-card p-8 rounded-2xl">
                  <div className="flex items-center justify-between mb-10">
                    <div>
                      ...
                      <p className="text-sm text-[#5c5f60]">Your path to Cloud Architect</p>
                    </div>
                  </div>
                  ...
                  <div className="relative pl-12 text-left">
                    ...
                    <div className="relative mb-14 group">
                      ...
                      <div className="glass-card p-6 rounded-2xl bg-white/40 border-[#00B894]/10 hover:bg-white/60 hover:translate-x-3 transition-all cursor-pointer">
                        <div className="flex flex-col md:flex-row justify-between md:items-center gap-2 mb-3">
                          <h4 className="text-lg font-bold text-[#261812]">Phase 1: Shell Scripting &amp; Containerization</h4>
                        ...
                        <p className="text-sm text-[#5a4136] leading-relaxed">Shell scripts scripting, Docker packaging, multi-stage images compilation, and registry uploads.</p>
                      </div>
                    </div>
                    ...
                    <div className="relative mb-14 group">
                      ...
                      <div className="glass-card p-6 rounded-2xl border border-vibrant-orange/30 bg-vibrant-orange/[0.03] hover:translate-x-3 transition-all cursor-pointer ring-4 ring-vibrant-orange/5">
                        <div className="flex flex-col md:flex-row justify-between md:items-center gap-2 mb-3">
                          <h4 className="text-lg font-bold text-[#261812]">Phase 2: Orchestration &amp; Cloud Infrastructure</h4>
                        ...
                        <p className="text-sm text-[#5a4136] leading-relaxed mb-4">Kubernetes services, YAML deployment specifications, Ingress controllers, and Helm charts management.</p>
                    ...
                    <div className="relative mb-14 group">
                      ...
                      <div className="glass-card p-6 rounded-2xl opacity-60 bg-[#fff1eb]/30 hover:translate-x-3 transition-all cursor-pointer grayscale-[0.5]">
                        <div className="flex flex-col md:flex-row justify-between md:items-center gap-2 mb-3">
                          <h4 className="text-lg font-bold text-[#261812]">Phase 3: CI/CD Pipeline Automation</h4>
                          <span className="inline-flex items-center gap-1 text-xs font-bold text-[#5c5f60] bg-[#ffeae1] px-3 py-1 rounded-full">
                            Locked
                          </span>
                        </div>
                        <p className="text-sm text-[#5a4136] leading-relaxed">GitHub Actions, Jenkins pipelines scripting, automated unit tests, and canary deployment pipelines.</p>
                      </div>
                    </div>
                    ...
                    <div className="relative group">
                      ...
                      <div className="glass-card p-6 rounded-2xl opacity-60 bg-[#fff1eb]/30 hover:translate-x-3 transition-all cursor-pointer grayscale-[0.5]">
                        <div className="flex flex-col md:flex-row justify-between md:items-center gap-2 mb-3">
                          <h4 className="text-lg font-bold text-[#261812]">Phase 4: Site Reliability Engineering &amp; Observability</h4>
                          <span className="inline-flex items-center gap-1 text-xs font-bold text-[#5c5f60] bg-[#ffeae1] px-3 py-1 rounded-full">
                            Locked
                          </span>
                        </div>
                        <p className="text-sm text-[#5a4136] leading-relaxed">Prometheus metrics collection, Grafana dashboards mapping, alert triggers, and SLO/SLA reporting metrics.</p>
                      </div>
                    </div>
              ...
              <div className="lg:col-span-4 flex flex-col gap-8 text-left">
                <div className="glass-card p-6 rounded-2xl bg-vibrant-orange/[0.04] border border-vibrant-orange/20 relative overflow-hidden group">
                  ...
                  <p className="text-sm italic text-[#261812] leading-relaxed mb-6 pl-4 border-l-2 border-vibrant-orange/30">
                    "Your container composition templates look very secure. Consider exploring <span className="font-bold text-vibrant-orange">eBPF network monitoring</span> before scaling to production clusters."
                  </p>
                ...
                <div className="glass-card p-6 rounded-2xl">
                  ...
                  <div className="space-y-5">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm font-bold text-[#261812]">18 hrs</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-bold text-[#261812]">89%</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="glass-card p-6 rounded-2xl">
                  ...
                  <div className="relative overflow-hidden rounded-xl mb-5 group cursor-pointer">
                    <img 
                      alt="Kubernetes node cluster topology" 
                      className="w-full h-44 object-cover group-hover:scale-110 transition-transform duration-700" 
                      src="https://images.unsplash.com/photo-1618401471353-b98aedd07871?auto=format&fit=crop&q=80&w=400" 
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent flex items-end p-5">
                      <div className="w-full text-left">
                        ...
                        <span className="text-white font-bold text-base">Lab: Pod Scaling Auto-Rules</span>
                      </div>
                    </div>
                  </div>
