              ...
              <div className="lg:col-span-8 flex flex-col gap-8">
                ...
                <div className="glass-card p-8 rounded-2xl flex flex-col md:flex-row items-center gap-10">
                  ...
                  <div className="flex-grow text-left">
                    <h3 className="text-2xl font-bold text-slate-900 mb-2">Current Focus: Orchestration &amp; Kubernetes Clusters</h3>
                    ...
                    <div className="flex items-center gap-6">
                      <div className="flex -space-x-3">
                        <div className="w-12 h-12 rounded-full border-4 border-white bg-blue-600/10 flex items-center justify-center cursor-pointer" title="Container Specialist">
                          <Cpu className="w-5 h-5 text-blue-600" />
                        </div>
                        <div className="w-12 h-12 rounded-full border-4 border-white bg-blue-600/10 flex items-center justify-center cursor-pointer" title="SRE Intern">
                  ...
                  <div className="relative pl-12 text-left">
                    ...
                    <div className="relative mb-14 group">
                      ...
                      <div className="glass-card p-6 rounded-2xl bg-white/40 border-[#00B894]/10 hover:bg-white/60 hover:translate-x-3 transition-all cursor-pointer">
                        <div className="flex flex-col md:flex-row justify-between md:items-center gap-2 mb-3">
                          <h4 className="text-lg font-bold text-slate-900">Phase 1: Shell Scripting &amp; Containerization</h4>
                    ...
                    <div className="relative mb-14 group">
                      ...
                      <div className="glass-card p-6 rounded-2xl border border-blue-600/30 bg-blue-600/[0.03] hover:translate-x-3 transition-all cursor-pointer ring-4 ring-blue-600/5">
                        <div className="flex flex-col md:flex-row justify-between md:items-center gap-2 mb-3">
                          <h4 className="text-lg font-bold text-slate-900">Phase 2: Orchestration &amp; Cloud Infrastructure</h4>
                    ...
                    <div className="relative mb-14 group">
                      ...
                      <div className="glass-card p-6 rounded-2xl opacity-60 bg-[#fff1eb]/30 hover:translate-x-3 transition-all cursor-pointer grayscale-[0.5]">
                        <div className="flex flex-col md:flex-row justify-between md:items-center gap-2 mb-3">
                          <h4 className="text-lg font-bold text-slate-900">Phase 3: CI/CD Pipeline Automation</h4>
                    ...
                    <div className="relative group">
                      ...
                      <div className="glass-card p-6 rounded-2xl opacity-60 bg-[#fff1eb]/30 hover:translate-x-3 transition-all cursor-pointer grayscale-[0.5]">
                        <div className="flex flex-col md:flex-row justify-between md:items-center gap-2 mb-3">
                          <h4 className="text-lg font-bold text-slate-900">Phase 4: Site Reliability Engineering &amp; Observability</h4>
                          <span className="inline-flex items-center gap-1 text-xs font-bold text-[#5c5f60] bg-[#ffeae1] px-3 py-1 rounded-full">
                            Locked
                          </span>
                        </div>
              ...
              <div className="lg:col-span-4 flex flex-col gap-8 text-left">
                <div className="glass-card p-6 rounded-2xl bg-blue-600/[0.04] border border-blue-600/20 relative overflow-hidden group">
                  ...
                  <p className="text-sm italic text-slate-900 leading-relaxed mb-6 pl-4 border-l-2 border-blue-600/30">
                    "Your container composition templates look very secure. Consider exploring <span className="font-bold text-blue-600">eBPF network monitoring</span> before scaling to production clusters."
                  </p>
                ...
                <div className="glass-card p-6 rounded-2xl">
                  ...
                  <div className="space-y-5">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm font-bold text-slate-900">18 hrs</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
