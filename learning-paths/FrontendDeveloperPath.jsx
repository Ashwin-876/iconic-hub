...
export default function FrontendDeveloperPath() {
  ...
  const mentors = [
    {
      name: "Sarah Jenkins",
      role: "NLP UI Architect",
      credentials: "Head of GenAI @ Anthropic, Ex-React Core team",
    ...
    },
    {
      ...
      credentials: "Senior Web Lead @ NVIDIA",
                  ...
                  <div className="relative pl-12 text-left">
                    ...
                    <div className="relative mb-14 group">
                      ...
                      <div className="glass-card p-6 rounded-2xl bg-white/40 border-[#00B894]/10 hover:bg-white/60 hover:translate-x-3 transition-all cursor-pointer">
                        ...
                        <p className="text-sm text-[#5a4136] leading-relaxed">Flexbox grids, grid layouts, container queries, custom CSS parameters, and animations.</p>
                      </div>
                    </div>
                    ...
                    <div className="relative mb-14 group">
                      ...
                      <div className="glass-card p-6 rounded-2xl bg-white/40 border-[#00B894]/10 hover:bg-white/60 hover:translate-x-3 transition-all cursor-pointer">
                        ...
                        <p className="text-sm text-[#5a4136] leading-relaxed">Hooks, lifecycle methods, state providers, global stores, and routing structures.</p>
                      </div>
                    </div>
                    ...
                    <div className="relative group">
                      ...
                      <div className="glass-card p-6 rounded-2xl opacity-60 bg-[#fff1eb]/30 hover:translate-x-3 transition-all cursor-pointer grayscale-[0.5]">
                        ...
                        <p className="text-sm text-[#5a4136] leading-relaxed">Three.js scene design, WebGL renders, canvas integrations, and creative hover animations.</p>
                      </div>
                    </div>
                ...
                <div className="glass-card p-6 rounded-2xl">
                  ...
                  <div className="relative overflow-hidden rounded-xl mb-5 group cursor-pointer">
                    <img 
                      ...
                      src="https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?auto=format&fit=crop&q=80&w=400" 
                    />
