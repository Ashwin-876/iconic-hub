...
export default function CourseDetails() {
  ...
  return (
    <PageTransition>
      <div className="min-h-screen bg-[#fff8f6] text-on-background font-sans pb-16 selection:bg-blue-600 selection:text-white">
        ...
        <main className="max-w-7xl mx-auto px-6 mt-8 space-y-6 text-left">
          {/* Back button */}
          <Link to="/courses" className="inline-flex items-center gap-2 text-xs font-bold text-slate-500 hover:text-blue-600 transition-colors">
          ...
          <div className="bg-white border border-surface-stroke rounded-[24px] p-6 md:p-8 shadow-sm space-y-6">
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                <span className="px-2.5 py-0.5 bg-blue-50 text-[10px] font-bold text-blue-600 rounded border border-blue-100 uppercase">
                  {course.level}
                </span>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="lg:col-span-4 space-y-6">
                  <div className="bg-white border border-surface-stroke rounded-3xl p-6 shadow-sm space-y-4">
                    ...
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-12 rounded-xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center text-blue-600 font-bold text-lg">
                        M
                      </div>
