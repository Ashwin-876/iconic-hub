  ...
  return (
    <div className="space-y-8 animate-fadeIn">
      ...
      <section className="bg-white border border-surface-stroke rounded-[32px] p-8 md:p-12 shadow-sm relative overflow-hidden flex flex-col lg:flex-row items-center justify-between gap-8">
        <div className="absolute top-0 right-0 w-[300px] h-[300px] bg-vibrant-orange/5 rounded-full blur-[100px] pointer-events-none"></div>
        
        <div className="space-y-6 max-w-xl text-left">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-vibrant-orange/10 text-vibrant-orange text-xs font-bold">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-on-background tracking-tight leading-tight">
            Your Personal <br />
            <span className="text-vibrant-orange">AI Learning Mentor</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-3 pt-2">
            <button onClick={() => setActiveTab('chat')} className="px-6 py-3 bg-vibrant-orange hover:bg-orange-600 text-white text-xs font-bold rounded-xl shadow-lg shadow-vibrant-orange/10 transition-all flex items-center gap-2">
        ...
        <div className="w-full lg:w-[380px] bg-slate-900 border border-slate-800 rounded-3xl p-5 shadow-xl font-sans text-xs text-slate-300 relative">
          ...
          <div className="space-y-4">
            <div className="flex gap-2">
              <div className="w-6 h-6 rounded-full bg-vibrant-orange/20 flex items-center justify-center text-vibrant-orange text-[10px] font-bold">U</div>
              <div className="bg-slate-800 p-2.5 rounded-2xl rounded-tl-none max-w-[80%] text-[11px] text-left">
                {typedText}<span className="w-1.5 h-3.5 bg-vibrant-orange inline-block align-middle ml-0.5 animate-pulse"></span>
              </div>
            </div>
            
            <div className="flex gap-2 justify-end">
              <div className="bg-vibrant-orange/15 border border-vibrant-orange/20 p-2.5 rounded-2xl rounded-tr-none max-w-[80%] text-[11px] text-left text-orange-200">
                <div className="font-semibold text-vibrant-orange text-[10px] mb-1 flex items-center gap-1">
              ...
              <div className="w-6 h-6 rounded-full bg-gradient-to-tr from-vibrant-orange to-amber-500 flex items-center justify-center text-white text-[10px] font-bold">AI</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-8 bg-white border border-surface-stroke rounded-3xl p-6 shadow-sm space-y-6 text-left">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <div className="p-4 bg-slate-50 rounded-2xl border border-surface-stroke">
              <Flame className="w-6 h-6 text-vibrant-orange mb-2" />
          ...
          <div className="bg-orange-500/[0.02] border border-orange-100 rounded-2xl p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="space-y-1">
              <h4 className="text-xs font-bold text-on-background flex items-center gap-1.5">
                <Sparkles className="w-3.5 h-3.5 text-vibrant-orange" /> Recommended Next Topic
              </h4>
              <p className="text-xs text-slate-600">Practice writing recursive React components with state encapsulation rules.</p>
            </div>
            <button onClick={() => setActiveTab('code')} className="px-4 py-2 bg-vibrant-orange hover:bg-orange-600 text-white text-[11px] font-bold rounded-xl shrink-0 transition-all">
              Practice Now
            </button>
          </div>
        </div>
        ...
        <div className="md:col-span-4 bg-white border border-surface-stroke rounded-3xl p-6 shadow-sm space-y-4 text-left">
          ...
          <div className="space-y-3">
            ...
            <div>
              <span className="text-[10px] font-bold text-vibrant-orange block mb-1 uppercase tracking-wide">Attention Suggested</span>
              <div className="flex flex-wrap gap-1.5">
                {weakConcepts.map((w, idx) => (
                  <span key={idx} className="px-2 py-0.5 bg-orange-50 border border-orange-100 text-[10px] font-semibold text-vibrant-orange rounded-md">{w}</span>
                ))}
              </div>
            </div>
          </div>
      ...
      <section className="bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800 text-white rounded-[32px] p-8 md:p-12 text-center relative overflow-hidden space-y-6">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[350px] h-[350px] bg-vibrant-orange/10 rounded-full blur-[120px] pointer-events-none"></div>
        ...
        <div className="flex flex-wrap justify-center gap-3">
          <button onClick={() => setActiveTab('chat')} className="px-6 py-3 bg-vibrant-orange hover:bg-orange-600 text-white text-xs font-bold rounded-xl transition-all shadow-lg shadow-vibrant-orange/20">
            Start AI Learning
          </button>
